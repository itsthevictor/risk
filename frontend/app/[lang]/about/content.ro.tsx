...
const IRRBB_SCENARIOS = [
  ...
  { scenario: 'Paralel jos', shock: '-200 bps pe toată curba' },
  {
    scenario: 'Steepener',
    shock:
      '-100 bps la capătul scurt, +150 bps la capătul lung (interpolat liniar)',
  },
  {
    scenario: 'Flattener',
  ...
  },
  {
    ...
    shock:
      '+250 bps la capătul scurt, descrescător exponențial spre capătul lung',
  },
  {
    ...
    <div className='mx-auto w-full max-w-4xl space-y-8 overflow-x-hidden p-4 sm:space-y-10 sm:p-6'>
      <div className='space-y-2'>
        ...
        <div className='space-y-2 text-sm leading-relaxed text-muted-foreground mt-6'>
          <p>
            ...
            (cache de prețuri), <Code>yfinance</Code> (sursă de date de piață),{' '}
            <Code>numpy</Code> / <Code>pandas</Code> (calcul numeric),{' '}
            <Code>scipy</Code> (distribuții statistice) și <Code>arch</Code>{' '}
            (calibrare GARCH).
          </p>
          <p>
            <strong className='text-foreground'>Frontend</strong> — Next.js +
            React + TypeScript, React Hook Form + Zod (formulare și validare),
            TanStack Query (fetching/cache pe client), Recharts (grafice),
      ...
      <Section title='1. Risc de Piață (Market Risk)' href='/market'>
        <p>
          ...
          backtesting istoric al fiecărei metode, și stress testing pe scenarii
          de criză (două scenarii istorice și opțiune de scenariu discret
          personalizat).
        </p>
        ...
        <p>
          Expected Shortfall (ES) se calculează, pentru fiecare metodă, ca media
          pierderilor care depășesc VaR-ul (istoric) sau prin formula închisă a
          cozii normale <Code>ES = σ · φ(z_cf) / (1 - cf)</Code>{' '}
          (parametric/EWMA/GARCH), respectiv media simulărilor sub prag (Monte
          Carlo).
        </p>
        ...
        <ul className='list-disc space-y-2 pl-5 text-muted-foreground'>
          <li>
            ...
            descărcat prin <Code>yfinance</Code> și cache-uit în Postgres (fetch
            incremental — se cer de la Yahoo doar zilele lipsă, nu tot
          ...
          <li>
            ...
            <em>acum</em>, dat fiind regimul de volatilitate recent&rdquo;, nu
            &bdquo;care a fost cea mai gravă coadă din tot istoricul
            disponibil&rdquo;.
          </li>
          <li>
            <strong className='text-foreground'>Orizont de 1 zi</strong>, fără
            scalare √t la un holding period mai lung — practica standard în risk
            management de piață, care evită autocorelația introdusă de
            randamente cumulate pe ferestre suprapuse.
          </li>
          <li>
            <strong className='text-foreground'>Ziua curentă e exclusă</strong>{' '}
            din fereastra de estimare (out-of-sample: se estimează riscul zilei
            t doar din randamentele strict anterioare lui t, fără să
            &bdquo;vadă&rdquo; rezultatul zilei respective) și din fetch-ul de
            preț (sesiunea de azi poate fi încă în desfășurare / nepublicată la
            Yahoo).
          </li>
          <li>
            <strong className='text-foreground'>Ponderi egale</strong> pe toate
            activele selectate (2–10 tickere).
          </li>
        </ul>

        <SubHeading>Backtesting</SubHeading>
        <p>
          Pentru fiecare metodă, se rulează un backtest rulant pe tot istoricul
          disponibil (nu doar pe fereastra curentă): pentru fiecare zi din
          trecut, se recalculează ce ar fi spus metoda folosind doar datele de
          dinainte, apoi se compară cu pierderea efectivă realizată. Din asta
          rezultă:
        </p>
        <ul className='list-disc space-y-2 pl-5 text-muted-foreground'>
          <li>
            <strong className='text-foreground'>Testul Kupiec</strong>{' '}
            (unconditional coverage) — verifică dacă <em>numărul</em> de
            depășiri ale VaR se potrivește cu ce ar aștepta nivelul de încredere
            ales.
          </li>
          <li>
            <strong className='text-foreground'>Testul Christoffersen</strong>{' '}
            (independence) — verifică dacă depășirile sunt <em>grupate</em> în
            timp (clustering, semn de model prost calibrat) sau independente.
          </li>
          <li>
          ...
          <li>
            <strong className='text-foreground'>Semafor stil Basel</strong>{' '}
        ...
        <ul className='list-disc space-y-2 pl-5 text-muted-foreground'>
          <li>
            ...
            singură dată pe tot istoricul, din randamentele efective realizate.
          </li>
          <li>
            <strong className='text-foreground'>
              Beneficiu de diversificare
            </strong>{' '}
            — diferența dintre suma VaR-urilor individuale (per activ, izolat)
            și VaR-ul parametric al portofoliului combinat; folosește tot
            istoricul de 15 ani, nu fereastra de estimare.
          </li>
          <li>
            <strong className='text-foreground'>Matrice de corelație</strong> —
            corelația randamentelor zilnice între toate activele selectate, pe
            tot istoricul.
          </li>
        </ul>
        ...
        <ul className='list-disc space-y-2 pl-5 text-muted-foreground'>
          <li>
            <strong className='text-foreground'>Replay istoric</strong> — aplică
            randamentele reale dintr-o fereastră acută de criză (COVID 19 feb–20
            mar 2020, rate-hike sell-off 27 dec 2021–14 oct 2022, sau un
        ...
        <p>
          ...
          scenariul 2020 rulat automat imediat ce analiza principală se termină.
        </p>
        ...
        <ul className='list-disc space-y-2 pl-5 text-muted-foreground'>
          <li>
            ...
            Volatilitate EWMA, Volatilitate GARCH, Drawdown Maxim, Beneficiu de
            Diversificare; fiecare cu grafic și explicație (formulă + pași de
            implementare) în drawer-ul de info.
          </li>
          <li>
            <strong className='text-foreground'>Tabel comparativ VaR/ES</strong>{' '}
            — toate cele 5 metode, pe cele 3 niveluri de încredere (90/95/99%),
            în dolari și procent din valoarea portofoliului.
          </li>
          <li>
            <strong className='text-foreground'>
              Tabel scorecard backtest
            </strong>{' '}
            — statusul traffic-light și statisticile Kupiec/Christoffersen/CC
            per metodă, cu selecție interactivă a metodei active pentru graficul
            de mai jos.
          </li>
          <li>
            <strong className='text-foreground'>Grafic PnL vs. VaR</strong> —
            P&L zilnic realizat suprapus peste seria de VaR a metodei selectate,
            cu zilele de depășire (breach) marcate.
          </li>
          <li>
            <strong className='text-foreground'>
              Carduri de rezultat stress test
            </strong>{' '}
            — impact în dolari/procent față de valoarea curentă a portofoliului,
            separat pentru replay istoric și scenariul ipotetic.
          </li>
        </ul>
      </Section>
      ...
      <Section title='2. Risc de Lichiditate — LCR' href='/liquidity'>
        <p>
          ...
          wizard cu 6 pași (HQLA, depozite retail, depozite en-gros, angajamente
          extrabilanțiere, intrări, rezultat).
        </p>
        <CodeBlock>
...
Ieșiri nete = Ieșiri totale − min(Intrări, 75% × Ieșiri totale)`}
        ...
        <p>
          ...
          funcție de tipul emitentului și, unde e cazul, de banda de rating — de
          exemplu suveranul propriu și numerarul la banca centrală sunt L1
          necondiționat, o obligațiune corporativă AAA-AA e L2A, iar una A/BBB e
          L2B. Maparea completă issuer_type × rating_band → nivel e
          configurabilă în{' '}
          <Code>backend/engines/liquidity_risk/config/lcr_params.json</Code>, nu
          hardcodată în motorul de calcul.
        </p>
        ...
        <p>După haircut, se aplică plafoanele reglementare, în ordine:</p>
        <ol className='list-decimal space-y-2 pl-5 text-muted-foreground'>
          <li>
            <strong className='text-foreground'>Plafon L2B</strong> — L2B este
            limitat la 15% din (L1 + L2A).
          </li>
          <li>
            <strong className='text-foreground'>Plafon L2 combinat</strong> —
            L2A + L2B (după plafonul de mai sus) este limitat la 40% din HQLA
            total; dacă e depășit, L2B e redus primul, iar dacă tot nu ajunge,
            se reduce și L2A.
          </li>
        </ol>
        ...
        <p>
          Pentru depozitele retail, en-gros și angajamentele extrabilanțiere se
          aplică o rată de run-off pe categorie (ex. 5% retail stabil, 10%
          ...
          categorie (0–100%, în funcție de tipul colateralului/contrapărții) și
          sunt plafonate global la 75% din ieșirile totale — o bancă nu se poate
          baza pe intrări pentru a-și acoperi integral ieșirile de stres. Toate
          ratele sunt configurabile în același fișier{' '}
        ...
        <ul className='list-disc space-y-2 pl-5 text-muted-foreground'>
          <li>
            ...
            salvare automată a draft-ului în <Code>sessionStorage</Code>, ca să
            nu se piardă la refresh accidental.
          </li>
          <li>
      ...
      >
        <p>
          ...
          economice a capitalului). Spre deosebire de Market Risk și LCR, datele
          de intrare nu sunt introduse manual — portofoliul este generat
          sintetic (100 de poziții mock), cu profiluri de repricing și
          maturitate regenerate per categorie (cash aproape overnight, depozite
          la termen pe termen mediu, obligațiuni guvernamentale și credite
          variabile pe termen lung etc.), reproductibil (seed fix), ca să
          reflecte un profil de scadență realist în ciuda datelor sursă
          (mockaroo) incoerente.
        </p>
        ...
        <p>
          ...
          Altfel, pro-rata — la rata curentă până la repricing, apoi la (rata
          curentă ± șoc) de la repricing până la finalul orizontului. ΔNII se
          calculează față de scenariul de bază (fără șoc), separat pentru șocul
          în sus și în jos.
        </p>
        ...
        <p>
          ...
          valoarea prezentă a pasivelor, actualizate pe curba de randament până
          la data de maturitate a fiecărei poziții:
        </p>
        ...
        <p>
          ...
          scenariul de bază — curba de randament e interpolată liniar pe ancore
          de maturitate (0–20 ani), fără extrapolare (plată în afara
          domeniului):
        </p>
        <div className='overflow-hidden rounded-md border'>
          <Table>
        ...
        <ul className='list-disc space-y-2 pl-5 text-muted-foreground'>
          <li>
            ...
            cele două perspective sunt afișate separat, fiecare cu propriul set
            de carduri KPI și tabel de scenarii.
          </li>
          <li>
            <strong className='text-foreground'>Carduri KPI NII</strong> — NII
            de bază, NII la șoc +bps și -bps, cu ΔNII și grafic comparativ pe
            scenarii; mărimea șocului e selectabilă din UI (100/200/300 bps).
          </li>
          <li>
          ...
          <li>
            <strong className='text-foreground'>Carduri KPI EVE</strong> — EVE
            de bază (cu grafic pe toate cele 7 scenarii), cel mai advers
          ...
          <li>
            ...
            — tabelul complet al celor 100 de poziții sintetice (tip, categorie,
            principal, rată curentă, date de repricing/ maturitate), sortabil pe
            orice coloană.
          </li>
        </ul>
      </Section>
      ...
      <Section title='4. Risc de Credit' href='/credit'>
        ...
        <p>
          ...
          reglementar (Risk-Weighted Assets) pentru un portofoliu de credite de
          consum, folosind cadrul standard PD–LGD–EAD din Basel II/III
          (abordarea IRB). Decizia de risc pe care o susține: câtă capitalizare
          trebuie alocată per segment de portofoliu, și ce grade de risc
          concentrează disproporționat expunerea la pierdere neașteptată —
          informație direct utilizabilă în stabilirea limitelor de subscriere
          sau în pricing pe grad.
        </p>
        <p>
          <strong className='text-foreground'>Date</strong> — Portofoliu de
          141.946 credite de consum negarantate (Lending Club, emise 2007–2018),
          cu informații despre debitor, termenii creditului (
        ...
        <p>
          ...
          — Regresie logistică, calibrată fără <Code>class_weight</Code> pentru
          a păstra probabilitățile interpretabile în magnitudine, nu doar în
          ordine de clasificare. Performanță: AUC 0.706, validată prin
          comparație cu un proiect independent similar (AUC 0.703). Modelul
          produce o probabilitate lifetime (pe toată durata creditului); pentru
          alinierea cu convenția reglementară Basel (PD pe orizont de 12 luni),
          aceasta e anualizată printr-o conversie hazard-rate constant:
        </p>
        ...
        <p>
          ...
          — Calculat empiric, din raportul dintre sumele recuperate și expunerea
          la momentul default-ului (<Code>funded_amnt - total_rec_prncp</Code>),
          pe subsetul creditelor charged-off. Media de portofoliu: 90,7%.
          Segmentarea pe grad de risc (A–G) arată variație neglijabilă
          (90,4%–91,0%) — rezultat consistent cu practica reglementară Basel,
          unde sub abordarea Foundation IRB, LGD-ul e fixat uniform de
          reglementator (45% senior / 75% subordonat) independent de rating-ul
          debitorului, tocmai pentru că recuperarea e determinată de
          senioritate/colateral, nu de bonitatea inițială. Pentru credit
          negarantat, fără diferențiere de colateral între grade, absența
          variației LGD e teoretic așteptată: gradul discriminează eficient
          probabilitatea de default, dar nu severitatea pierderii odată ce
          acesta s-a produs.
        </p>
        <p>
        ...
        <p>
          ...
          — Formula IRB avansată pentru expuneri retail: corelație R dependentă
          de PD (Vasicek single-factor model), funcție de capital K la
          percentila de încredere reglementară 99,9%:
        </p>
        ...
        <p>
          ...
          ignorată) și atribuită discordanței de orizont temporal dintre PD-ul
          modelului (calibrat implicit pe un target lifetime) și convenția
          reglementară de PD pe 12 luni, nu unei erori de calcul a EAD/LGD.
          Corecția prin anualizare hazard-rate a adus rezultatul în linia
          benchmark-ului.
        </p>
        ...
        <ul className='list-disc space-y-2 pl-5 text-muted-foreground'>
          ...
          <li>
            ...
            reflectă profilul de risc structural al creditului de consum
        ...
        <ul className='list-disc space-y-2 pl-5 text-muted-foreground'>
          <li>
            ...
            capital, cu status vizual (verde/galben/roșu, praguri la 60% și 100%
            densitate).
          </li>
          <li>
            <strong className='text-foreground'>
